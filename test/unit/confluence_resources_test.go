...
// testConfluenceForbiddenMockServer and testConfluenceServerErrorMockServer
// are defined in confluence_space_test.go and shared across confluence test files.
