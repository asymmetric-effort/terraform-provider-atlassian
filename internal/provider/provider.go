	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"api_key": schema.StringAttribute{
				Description: "Atlassian Admin API key (Bearer token). Created at admin.atlassian.com under Organization settings > API Keys. May be set via ATLASSIAN_API_KEY environment variable.",
				Optional:    true,
				Sensitive:   true,
			},
...
func (p *AtlassianProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		spaceresource.NewComponentResource,
		spaceresource.NewVersionResource,
		...
		screenresource.NewIssueTypeScreenSchemeResource,
		screenresource.NewTabResource,
...
func (p *AtlassianProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		spacedatasource.NewComponentDataSource,
		spacedatasource.NewVersionDataSource,
		...
		screendatasource.NewIssueTypeScreenSchemeDataSource,
		screendatasource.NewTabDataSource,
